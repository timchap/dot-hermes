...
description: Use when controlling a running TouchDesigner instance via twozero MCP — creating operators, setting parameters, wiring connections, executing Python, or building real-time visuals.
version: 1.1.0
