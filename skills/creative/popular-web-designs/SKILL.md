...
description: Use when building a page that should look like a known brand or product — providing 54 real design systems (Stripe, Linear, Vercel, etc.) as ready-to-paste HTML/CSS templates.
version: 1.0.0
...
metadata:
  hermes:
    tags: [design, css, html, ui, web-development, design-systems, templates, brand-matching]
