---
name: comfyui
description: Use when generating images, video, or audio with ComfyUI — managing nodes, running workflows with parameter injection, and orchestrating generative pipelines via the REST/WebSocket API.
version: 5.1.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [comfyui, image-generation, stable-diffusion, flux, sd3, wan-video, video-generation, creative, generative-ai]
    related_skills: [ascii-video, manim-video, p5js]
---
